"""What machine is this, and can ProjectOS honestly run on it?
...
#: Physical RAM below which ProjectOS refuses to install. Between the most a
...
def detect(proc_root: str = "/proc", dt_root: str = "/proc/device-tree") -> Board:
    ...
    if ram_mb and ram_mb < MINIMUM_RAM_MB:
        supported, reason = False, (
            "%s has %d MB of RAM. ProjectOS needs at least 1 GB -- below that the "
