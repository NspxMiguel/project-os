...
``GET /api/devices/{id}/recipes`` (in :mod:`projectos.api.devices`) answers the
...
from projectos.main import get_config, get_devices, get_plugins
...
async def _run(
    ...
    # install
    from projectos.api import store
