"""whatsapp-bot -- ProjectOS's own line into WhatsApp.
...
Layout::
    ...
    web/panel.js     the ProjectOS-hosted control panel
...
* Every credential-shaped config key (``access_token``, ``verify_token``,
  ...
  ``projectos.config.is_secret_key`` and comes back redacted from
