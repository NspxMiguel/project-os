...
Baileys or WPPConnect next to ProjectOS.
...
through Cloud API approval. ProjectOS does not run the bridge itself -- see
...
class BridgeProvider(Provider):
    ...
    def status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            # line, a file) is different per project, and ProjectOS does not
