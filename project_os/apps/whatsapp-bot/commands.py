...
Other project-os apps register a command without importing this module -- they
...
class CommandContext(object):
    ...
    handler reach other project-os state the same way an HTTP route would
    (``from project_os.main import get_plugins; get_plugins(request)``, for
